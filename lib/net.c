...
int sels(fd_set *fptr, int soca, int socb) {
	int erro, fmax = 0, tims = 0, timm = 750000;
...
void fcon(int sock, int midx, pckt_h *head, ciph_o *cryp) {
	int erro = 1;
